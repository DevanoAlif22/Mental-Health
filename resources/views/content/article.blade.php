...
<html lang="en">
  ...
  <body>
    ...
    <div class="container-fluid mb-5">
        ...
        <div class="container">
            <img class="img-article" style="width: 100%" src="{{asset('/images/content/article1.png')}}" alt="">
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 d-flex">
                    ...
                    <div style="margin-left: 20px">
                        <h3>Apa Itu Gangguan Kesehatan Mental?</h3>
                        <h6>Devano Alif</h6>
                    </div>
        ...
        <div class="container mb-5" style="margin-bottom: 30px;">
            ...
            <div class="content">
                ...
                Remaja juga perlu menjaga pola makan yang sehat dan berimbang. Makan makanan bergizi dapat memberikan energi yang cukup untuk menjaga kesehatan fisik dan mental. Hindari mengonsumsi makanan cepat saji atau junk food yang dapat mempengaruhi suasana hati dan kesejahteraan secara keseluruhan. <br><br>
